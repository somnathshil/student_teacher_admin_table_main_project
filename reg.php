...
<body>
	<h1 style="text-align: center;background-color: #bf8b54;height: 3rem;width: 65%;margin: auto;margin-bottom: 2rem;">New Registration</h1>
	<div class="regformcont">
	<form method="post" action="reg_action.php" enctype="multipart/form-data">
		...
		<input type="number" name="phone"  class="input phoneInput" oninput="phoneValid()"><br>
