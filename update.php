...
$_SESSION['oldImage'] = $result['stu_image'];
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<h1 style="text-align: center;background-color: #bf8b54;height: 3rem;width: 65%;margin: auto;margin-bottom: 2rem;">Update Profile</h1>
	<div class="ediformcont">
	<form method="post" action="update_action.php" enctype="multipart/form-data">
		<input type="hidden" name="stu_id" value="<?php echo $result['stu_id']; ?>">
		<label for="name">Name :</label><br>
		<input type="text" name="name" value="<?php echo $result['stu_name']; ?>" class="input nameInput"  oninput="nameValid()"><br>
		<div class="nameErrDiv" style="width:90%"></div>


		<label for="email">Email :</label><br>
		<input type="text" name="email" value="<?php echo $result['stu_email']; ?>" class="input emailInput"  oninput="emailValid()"><br>
		<div class="emailErrDiv" style="width:90%"></div>

		<label for="phone">Phone :</label><br>
		<input type="text" name="phone" value="<?php echo $result['stu_phone']; ?>" class="input phoneInput" oninput="phoneValid()"><br>
		<div class="phoneErrDiv" style="width:90%"></div>


		<label for="gender">Gender :</label><br>
		<input type="radio" name="gender" value="male" <?php  if($result['stu_gender'] == "male"){echo "checked";} ?> onchange="genderValid()">Male
		<input type="radio" name="gender" value="female" <?php  if($result['stu_gender'] == "female"){echo "checked";} ?> onchange="genderValid()">Female<br>
		<div class="genderErrDiv" style="width:90%"></div>


          <img src="<?php echo $result['stu_image']; ?>" width="100" height="100" ><br>
